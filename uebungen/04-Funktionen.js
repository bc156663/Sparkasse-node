...
// So werden Funkionen erstellt:

// 1. Das reservierte Wort function
// 2. Ein sprechender Name. D.h., der Name soll beschreiben, was die Funktion macht. (berechneFlaecheninhalt)
...
// 4. In der geschweiften Klammern wird die Logik ausprogrammiert.
...
console.log("=========")
// Berechne den Bruttopreis auf dem Nettopreis:
...
// Funktionen können auch innerhalbvon Klassen definiert werden.
// Beispiel: Kredit
...
class Kredit{
    ...
    berechneGesamtkostenAmEndeDerLaufzeit(){
        return this.Betrag + this.Bertag * this.Zinssatz
    }
}
